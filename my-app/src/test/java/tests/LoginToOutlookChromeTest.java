...
public class LoginToOutlookChromeTest {
	...
	public void OpenOutlookPage() throws InterruptedException
	{
		...
		//Sign in using email and password
			...
			//Check whether we have logged in successfully by looking for the 'Outlook' text in the title bar of the page.
			wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("Outlook")));
			//LoginPageOutlook outlookPage=new LoginPageOutlook(driver);
			
			//Find New Message link
